...
bench get-app https://github.com/anantamurti/erpnext --branch "$BRANCH_TO_CLONE" --resolve-deps
bench get-app https://github.com/anantamurti/lending --branch ${BRANCH_TO_CLONE%"-hotfix"}
